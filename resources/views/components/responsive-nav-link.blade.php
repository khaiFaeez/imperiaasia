...
$classes = ($active ?? false)
            ...
            : 'block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium  hover: hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus: focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out';
@endphp
