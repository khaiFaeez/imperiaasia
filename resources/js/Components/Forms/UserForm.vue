...
<div class="md:flex md:items-center mb-3">
    ...
    <div class="md:w-2/3">
                <BreezeInput id="password" type="password" class="mt-1 block w-full" v-model="user.password" required autocomplete="new-password" />
    </div>
  </div>
...
<div class="md:flex md:items-center mb-3">
    ...
    <div class="md:w-2/3">
                <BreezeInput id="password_confirmation" type="password" class="mt-1 block w-full" v-model="user.password_confirmation" required autocomplete="new-password" />
    </div>
  </div>
