...
<template>
    ...
    <AppLayout>
        ...
        <h1 class="mb-8 text-2xl font-bold flex gap-2 items-center">
            <Link class="text-primary hover:text-primary-focus" href="/print">Dashboard</Link>
        </h1>
        <div class="max-w-7xl">
            <div class="stats stats-vertical lg:stats-horizontal shadow w-full border-2 border-success">
