...
<template>
    ...
    <AppLayout>
        <h1 class="mb-8 text-2xl font-bold flex gap-2 items-center">
            ...
            <span class="text-primary font-medium">/</span><span class="capitalize">{{
                $page.props.role.name
                }}</span> <span class="badge badge-lg capitalize">{{$page.props.role.portfolio_name }}</span>
