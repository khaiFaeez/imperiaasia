        ...
        <div class="drawer drawer-mobile">
            ...
            <div class="drawer-side bg-neutral text-neutral-content overflow-y-visible">
                ...
                <ul class="menu menu-compact w-80 p-0 px-4 overflow-y-auto">
                    ...
                    <li v-if="hasAnyPermission(['client-list', 'client-edit', 'client-create'])">
                    ...
                    <li v-if="hasAnyPermission(['invoice-list', 'invoice-edit', 'invoice-create'])">
                    ...
                    <li v-if="hasAnyPermission(['user-list', 'user-edit', 'user-create'])">
